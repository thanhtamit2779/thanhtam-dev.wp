<?php
function hugeshop_product_sharing() {
	global $hugeshop_opt;
	...
	<div class="widget widget_socialsharing_widget">
		<h3 class="widget-title"><?php if(isset($hugeshop_opt['product_share_title'])) { echo esc_html($hugeshop_opt['product_share_title']); } else { _e('Share this product', 'hugeshop'); } ?></h3>
