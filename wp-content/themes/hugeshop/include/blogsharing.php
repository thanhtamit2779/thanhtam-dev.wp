<?php
function hugeshop_blog_sharing() {
	...
	<div class="widget widget_socialsharing_widget">
		<h3 class="widget-title"><?php if(isset($hugeshop_opt['blog_share_title'])) { echo esc_html($hugeshop_opt['blog_share_title']); } else { _e('Share this post', 'hugeshop'); } ?></h3>
