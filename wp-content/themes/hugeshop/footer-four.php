			...
			<div class="container">
				<div class="footer-middle-inner">
					<div class="row">
						...
						<?php if(isset($hugeshop_opt['about_us8']) && $hugeshop_opt['about_us8']!=''){ ?>
							<div class="col-xs-12 col-md-3 col-sm-6">
								<div class="widget widget_about_us">
								<?php echo wp_kses($hugeshop_opt['about_us8'], array(
										'a' => array(
									'href' => array(),
									'title' => array()
									),
					...
					<div class="row">
						...
						<div class="col-lg-6 col-md-6 col-sm-6">
							<div class="widget-payment">
								<?php if(isset($hugeshop_opt['payment_icons2']) && $hugeshop_opt['payment_icons2']!='' ) {
									echo wp_kses($hugeshop_opt['payment_icons2'], array(
										'a' => array(
											'href' => array(),
											'title' => array()
										),
