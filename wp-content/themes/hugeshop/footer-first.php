		...
		<div class="footer-top">	
			<div class="container">
				<div class="footer-top-inner">
					<?php if(isset($hugeshop_opt['about_us']) && $hugeshop_opt['about_us']!=''){ ?>
						<?php if( isset($hugeshop_opt['logo_footer']['url']) ){ ?>
							<div class="widget-logo"><a href="<?php echo esc_url( home_url( '/' ) ); ?>" title="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>" rel="home"><img src="<?php echo esc_url($hugeshop_opt['logo_footer']['url']); ?>" alt="" /></a></div>
						<?php } ?>
						<div class="widget widget_about_us">
						<?php echo wp_kses($hugeshop_opt['about_us'], array(
								'a' => array(
									'href' => array(),
									'title' => array()
								),
