		...
		<div class="post-info">
			...
			<?php else : ?>
				<div class="entry-summary">
					<?php the_excerpt(); ?>
					<a class="readmore button" href="<?php the_permalink(); ?>"><?php if(isset($hugeshop_opt['readmore_text']) && $hugeshop_opt['readmore_text']!=''){ echo esc_html($hugeshop_opt['readmore_text']); } else { echo esc_html_e('Read more', 'hugeshop');}  ?></a>
				</div>
			<?php endif; ?>
