...
global $projects_loop, $post, $hugeshop_projectrows, $hugeshop_opt, $wp_query;
...
<div class="main-container full-width">
		...
		<div class="container">
			<div class="title-breadcrumb-inner">
				<header class="entry-header">
					<h1 class="entry-title"><?php _e('Portfolio', 'hugeshop');?></h1>
				</header>
	...
	<div class="container">
		...
		<div class="page-content">
			...
			if( isset($hugeshop_opt['portfolio_per_page']) ) {
				$projects_per_page = $hugeshop_opt['portfolio_per_page'];
			}
			...
			<?php if ( $projects_query->have_posts() ) : ?>
				...
				<div class="filter-options btn-group">
					<button data-group="all" class="btn active btn--warning"><?php _e('All', 'hugeshop');?></button>
					<?php 
					$datagroups = array();
