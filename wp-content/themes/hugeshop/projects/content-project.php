...
global $post, $projects_loop, $hugeshop_opt, $hugeshop_projectrows, $hugeshop_projectsfound;
...
$projects_loop['columns'] = $hugeshop_opt['portfolio_columns'];
...
<?php if ( ( 0 == $projects_loop['loop'] % 2 || $hugeshop_projectsfound == $projects_loop['loop'] ) && ( $projects_loop['columns'] == 2 ) ) { /* for odd case: $hugeshop_projectsfound == $projects_loop['loop'] */
	if($hugeshop_projectrows!=1) {
		echo '</div>';
	}
} ?>