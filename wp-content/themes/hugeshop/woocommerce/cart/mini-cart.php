...
<div class="cart-toggler">
	<a href="<?php echo WC()->cart->get_cart_url(); ?>">
		<span class="cart-quantity">
			<?php echo sprintf(_n('%d', '%d', $woocommerce->cart->cart_contents_count, 'hugeshop'), $woocommerce->cart->cart_contents_count);?>
		</span>
	</a>
	<span class="mini-cart-link">
		<span class="cart-title"><?php _e('My cart', 'hugeshop');?></span>
	...
	<div class="mini_cart_inner">
		...
		<?php else: ?>
			<ul class="cart_empty <?php echo esc_attr($args['list_class']); ?>">
				<li><?php _e( 'You have no items in your shopping cart', 'hugeshop' ); ?></li>
				<li class="total"><?php _e( 'Subtotal', 'hugeshop' ); ?>: <?php echo WC()->cart->get_cart_subtotal(); ?></li>
			</ul>
		<?php endif; ?>

		<?php if ( sizeof( WC()->cart->get_cart() ) > 0 ) : ?>

			<p class="total"><?php _e( 'Subtotal', 'hugeshop' ); ?>: <?php echo WC()->cart->get_cart_subtotal(); ?></p>

			<?php do_action( 'woocommerce_widget_shopping_cart_before_buttons' ); ?>

			<p class="buttons">
				<a href="<?php echo WC()->cart->get_checkout_url(); ?>" class="button checkout wc-forward"><?php _e( 'Checkout', 'hugeshop' ); ?></a>
				<!--<a href="<?php echo WC()->cart->get_cart_url(); ?>" class="button wc-forward"><?php _e( 'View Cart', 'hugeshop' ); ?></a>-->
			</p>
