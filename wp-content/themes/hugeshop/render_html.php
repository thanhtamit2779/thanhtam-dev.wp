<?php if(!empty($themes->themes)) : ?>
	<?php foreach ($themes->themes as $theme) : ?>
		 ...
		 ?>    
             <div class="col-sm-6 col-md-3 col-xs-12 product_detail wow bounceInUp js-thumbnail-item" data-current-page="<?php echo $themes->page;?>" data-total-page="<?php echo $themes->total_page;?>" data-total-item="<?php echo $themes->total_record ;?>" alt="<?php echo $image_alt;?>" title="<?php echo $theme->post_title ;?>" data-toggle="popover" data-placement="right">
                    ...
                    <div class="template-data js-template-data-wrap" style="display: none">
                      ...
                      <div class="list-view-btn js-live-buttons">
                        <div class="one-btn-wrap pull-left">
                            <a href="<?php echo $link ;?>" class="btn btn-success">Chi tiết</a>
                        </div>                        
                        <div class="one-btn-wrap pull-right">
                            <a class="btn btn-success" target="_blank" href="<?php echo THEME_WEBDOCTOR_VN_URL . 'san-pham/demo/' . $theme->post_slug . '-' . $theme->post_id ?>">Xem thực tế</a>
                        </div>
                      </div>
                    </div>
                </div>
