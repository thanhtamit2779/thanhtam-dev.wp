	...
	<?php 
		if ( is_single() ) { ?>
			<div class="post-thumbnail">
				<?php echo do_shortcode(get_post_meta( $post->ID, '_hugeshop_meta_value_key', true )); ?>
		...
		<div class="post-info">
			...
			<?php else : ?>
				<div class="entry-summary">
					<?php the_excerpt(); ?>
					<a class="readmore button" href="<?php the_permalink(); ?>"><?php if(isset($hugeshop_opt['readmore_text']) && $hugeshop_opt['readmore_text']!=''){ echo esc_html($hugeshop_opt['readmore_text']); } else { esc_html__('Read more', 'hugeshop');}  ?></a>
				</div>
			<?php endif; ?>
			...
			<?php if ( is_single() ) : ?>
				...
				<div class="author-info">
					...
					<div class="author-description">
						<h2><?php esc_html__( 'About the Author:', 'hugeshop'); printf( '<a href="'.esc_url( get_author_posts_url( get_the_author_meta( 'ID' ) ) ).'" rel="author">%s</a>' , get_the_author()); ?></h2>
					...
					<div class="row">
						<?php
					    	...
					    	<div class="relatedthumb col-md-4">
						        ...
						        <a class="readmore button" href="<?php get_the_permalink($post->ID); ?>"><?php if(isset($hugeshop_opt['readmore_text']) && $hugeshop_opt['readmore_text']!=''){ echo esc_html($hugeshop_opt['readmore_text']); } else { esc_html__('Read more', 'hugeshop');}  ?></a>
						    </div>
