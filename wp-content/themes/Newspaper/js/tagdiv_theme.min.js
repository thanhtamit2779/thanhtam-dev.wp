...
(function(a){var b=0,c=0,d=0,e=0,f="ontouchstart"in window||0<navigator.msMaxTouchPoints,l="onorientationchange"in window,g=!1,n=!1,u=!1,G=!1,v=!1,w="pointer",D="pointer",W=[],U=[],ma=[],Y=[],L=[],ba=[],M=[],p=[],z=[],ca=[],ha=[],m={showScrollbar:function(b,c){b.scrollbarHide&&a("."+c).css({opacity:b.scrollbarOpacity,filter:"alpha(opacity:"+100*b.scrollbarOpacity+")"})},hideScrollbar:function(a,b,c,d,e,f,g,l,n,u){if(a.scrollbar&&a.scrollbarHide)for(var h=c;h<c+25;h++)b[b.length]=m.hideScrollbarIntervalTimer(10*
h,d[c],(c+24-h)/24,e,f,g,l,n,u,a)},hideScrollbarInterval:function(b,c,h,d,f,k,g,l,n){e=-1*b/z[l]*(f-k-g-d);m.setSliderOffset("."+h,e);a("."+h).css({opacity:n.scrollbarOpacity*c,filter:"alpha(opacity:"+n.scrollbarOpacity*c*100+")"})},slowScrollHorizontalInterval:function(b,c,h,d,f,k,g,l,n,u,E,O,v,F,y,t,w,q,B){if(B.infiniteSlider){if(h<=-1*z[t]){var H=a(b).width();if(h<=-1*ca[t]){var A=-1*E[0];a(c).each(function(b){m.setSliderOffset(a(c)[b],A+w);b<O.length&&(O[b]=-1*A);A+=y[b]});h+=-1*O[0];p[t]=-1*
O[0]+w;z[t]=p[t]+H-k;M[t]=0}else{var x=0,S=m.getSliderOffset(a(c[0]),"x");a(c).each(function(a){m.getSliderOffset(this,"x")<S&&(S=m.getSliderOffset(this,"x"),x=a)});v=p[t]+H;m.setSliderOffset(a(c)[x],v);p[t]=-1*O[1]+w;z[t]=p[t]+H-k;O.splice(0,1);O.splice(O.length,0,-1*v+w);M[t]++}}if(h>=-1*p[t]||0<=h){H=a(b).width();if(0<h)for(A=-1*E[0],a(c).each(function(b){m.setSliderOffset(a(c)[b],A+w);b<O.length&&(O[b]=-1*A);A+=y[b]}),h-=-1*O[0],p[t]=-1*O[0]+w,z[t]=p[t]+H-k,M[t]=F;0<-1*O[0]-H+w;){var K=0;var Q=
m.getSliderOffset(a(c[0]),"x");a(c).each(function(a){m.getSliderOffset(this,"x")>Q&&(Q=m.getSliderOffset(this,"x"),K=a)});v=p[t]-y[K];m.setSliderOffset(a(c)[K],v);O.splice(0,0,-1*v+w);O.splice(O.length-1,1);p[t]=-1*O[0]+w;z[t]=p[t]+H-k;M[t]--;L[t]++}0>h&&(K=0,Q=m.getSliderOffset(a(c[0]),"x"),a(c).each(function(a){m.getSliderOffset(this,"x")>Q&&(Q=m.getSliderOffset(this,"x"),K=a)}),v=p[t]-y[K],m.setSliderOffset(a(c)[K],v),O.splice(0,0,-1*v+w),O.splice(O.length-1,1),p[t]=-1*O[0]+w,z[t]=p[t]+H-k,M[t]--)}}E=
!1;k=m.calcActiveOffset(B,h,O,k,M[t],F,u,t);v=(k+M[t]+F)%F;B.infiniteSlider?v!=ba[t]&&(E=!0):k!=L[t]&&(E=!0);if(E&&(F=new m.args("change",B,b,a(b).children(":eq("+v+")"),v,q),a(b).parent().data("args",F),""!=B.onSlideChange))B.onSlideChange(F);L[t]=k;ba[t]=v;h=Math.floor(h);m.setSliderOffset(b,h);B.scrollbar&&(e=Math.floor((-1*h-p[t]+w)/(z[t]-p[t]+w)*(g-l-f)),b=f-n,h>=-1*p[t]+w?(b=f-n- -1*e,m.setSliderOffset(a("."+d),0)):(h<=-1*z[t]+1&&(b=g-l-n-e),m.setSliderOffset(a("."+d),e)),a("."+d).css({width:b+
"px"}))},slowScrollHorizontal:function(b,c,h,d,e,f,g,l,n,u,v,w,G,F,y,t,D,q,B,C,P){var k=m.getSliderOffset(b,"x");f=[];var H=0,x=25/1024*l;frictionCoefficient=P.frictionCoefficient;elasticFrictionCoefficient=P.elasticFrictionCoefficient;snapFrictionCoefficient=P.snapFrictionCoefficient;e>P.snapVelocityThreshold&&P.snapToChildren&&!B?H=1:e<-1*P.snapVelocityThreshold&&P.snapToChildren&&!B&&(H=-1);e<-1*x?e=-1*x:e>x&&(e=x);a(b)[0]!==a(q)[0]&&(H*=-1,e*=-2);q=M[y];if(P.infiniteSlider){var A=p[y];var S=z[y]}B=
[];for(var x=[],K=0;K<G.length;K++)B[K]=G[K],K<c.length&&(x[K]=m.getSliderOffset(a(c[K]),"x"));for(;1<e||-1>e;){e*=frictionCoefficient;k+=e;(k>-1*p[y]||k<-1*z[y])&&!P.infiniteSlider&&(e*=elasticFrictionCoefficient,k+=e);if(P.infiniteSlider){if(k<=-1*S){S=a(b).width();for(var E=0,Q=x[0],K=0;K<x.length;K++)x[K]<Q&&(Q=x[K],E=K);K=A+S;x[E]=K;A=-1*B[1]+C;S=A+S-l;B.splice(0,1);B.splice(B.length,0,-1*K+C);q++}if(k>=-1*A){S=a(b).width();E=0;Q=x[0];for(K=0;K<x.length;K++)x[K]>Q&&(Q=x[K],E=K);K=A-F[E];x[E]=
K;B.splice(0,0,-1*K+C);B.splice(B.length-1,1);A=-1*B[0]+C;S=A+S-l;q--}}f[f.length]=k}x=!1;e=m.calcActiveOffset(P,k,B,l,q,D,L[y],y);P.snapToChildren&&(P.infiniteSlider?(e+q+D)%D!=ba[y]&&(x=!0):e!=L[y]&&(x=!0),0>H&&!x?(e++,e>=G.length&&!P.infiniteSlider&&(e=G.length-1)):0<H&&!x&&(e--,0>e&&!P.infiniteSlider&&(e=0)));if(P.snapToChildren||(k>-1*p[y]||k<-1*z[y])&&!P.infiniteSlider){for((k>-1*p[y]||k<-1*z[y])&&!P.infiniteSlider?f.splice(0,f.length):(f.splice(.1*f.length,f.length),k=0<f.length?f[f.length-
1]:k);k<B[e]-.5||k>B[e]+.5;)k=(k-B[e])*snapFrictionCoefficient+B[e],f[f.length]=k;f[f.length]=B[e]}H=1;0!=f.length%2&&(H=0);for(k=0;k<h.length;k++)clearTimeout(h[k]);q=(e+q+D)%D;A=0;for(k=H;k<f.length;k+=2)if(k==H||1<Math.abs(f[k]-A)||k>=f.length-2)A=f[k],h[h.length]=m.slowScrollHorizontalIntervalTimer(10*k,b,c,f[k],d,g,l,n,u,v,e,w,G,t,D,F,y,C,q,P);A=(e+M[y]+D)%D;""!=P.onSlideComplete&&1<f.length&&(h[h.length]=m.onSlideCompleteTimer(10*(k+1),P,b,a(b).children(":eq("+A+")"),q,y));Y[y]=h;m.hideScrollbar(P,
h,k,f,d,g,l,u,v,y)},onSlideComplete:function(b,c,h,d,e){h=new m.args("complete",b,a(c),h,d,d);a(c).parent().data("args",h);if(""!=b.onSlideComplete)b.onSlideComplete(h)},getSliderOffset:function(b,c){c="x"==c?4:5;if(!g||n||u)var h=parseInt(a(b).css("left"),10);else{h=["-webkit-transform","-moz-transform","transform"];for(var d,e=0;e<h.length;e++)if(void 0!=a(b).css(h[e])&&0<a(b).css(h[e]).length){d=a(b).css(h[e]).split(",");break}h=void 0==d[c]?0:parseInt(d[c],10)}return h},setSliderOffset:function(b,
c){c=parseInt(c,10);!g||n||u?a(b).css({left:c+"px"}):a(b).css({msTransform:"matrix(1,0,0,1,"+c+",0)",webkitTransform:"matrix(1,0,0,1,"+c+",0)",MozTransform:"matrix(1,0,0,1,"+c+",0)",transform:"matrix(1,0,0,1,"+c+",0)"})},setBrowserInfo:function(){null!=navigator.userAgent.match("WebKit")?(w="-webkit-grab",D="-webkit-grabbing"):null!=navigator.userAgent.match("Gecko")?(v=!0,w="move",D="-moz-grabbing"):null!=navigator.userAgent.match("MSIE 7")?G=n=!0:null!=navigator.userAgent.match("MSIE 8")?G=u=!0:
null!=navigator.userAgent.match("MSIE 9")&&(G=!0)},has3DTransform:function(){var b=!1,c=a("<div />").css({msTransform:"matrix(1,1,1,1,1,1)",webkitTransform:"matrix(1,1,1,1,1,1)",MozTransform:"matrix(1,1,1,1,1,1)",transform:"matrix(1,1,1,1,1,1)"});""==c.attr("style")?b=!1:v&&21<=parseInt(navigator.userAgent.split("/")[3],10)?b=!1:void 0!=c.attr("style")&&(b=!0);return b},getSlideNumber:function(a,b,c){return(a-M[b]+c)%c},calcActiveOffset:function(a,b,c,d,e,f,g,l){e=!1;a=[];var h;b>c[0]&&(h=0);b<c[c.length-
1]&&(h=f-1);for(f=0;f<c.length;f++)c[f]<=b&&c[f]>b-d&&(e||c[f]==b||(a[a.length]=c[f-1]),a[a.length]=c[f],e=!0);0==a.length&&(a[0]=c[c.length-1]);for(f=e=0;f<a.length;f++)g=Math.abs(b-a[f]),g<d&&(e=a[f],d=g);for(f=0;f<c.length;f++)e==c[f]&&(h=f);return h},changeSlide:function(b,c,d,e,f,g,l,n,u,v,w,p,D,F,y,t,G,q){m.autoSlidePause(F);for(var h=0;h<e.length;h++)clearTimeout(e[h]);var k=Math.ceil(q.autoSlideTransTimer/10)+1,H=m.getSliderOffset(c,"x"),A=p[b],x=A-H;if(q.infiniteSlider)for(b=(b-M[F]+2*t)%
t,h=!1,0==b&&2==t&&(b=t,p[b]=p[b-1]-a(d).eq(0).outerWidth(!0),h=!0),A=p[b],x=A-H,A=[p[b]-a(c).width(),p[b]+a(c).width()],h&&p.splice(p.length-1,1),h=0;h<A.length;h++)Math.abs(A[h]-H)<Math.abs(x)&&(x=A[h]-H);var A=[];m.showScrollbar(q,f);for(h=0;h<=k;h++){var K=h;K/=k;K--;K=H+x*(Math.pow(K,5)+1);A[A.length]=K}k=(b+M[F]+t)%t;for(h=H=0;h<A.length;h++){if(0==h||1<Math.abs(A[h]-H)||h>=A.length-2)H=A[h],e[h]=m.slowScrollHorizontalIntervalTimer(10*(h+1),c,d,A[h],f,g,l,n,u,v,b,w,p,y,t,D,F,G,k,q);0==h&&""!=
q.onSlideStart&&(x=(L[F]+M[F]+t)%t,q.onSlideStart(new m.args("start",q,c,a(c).children(":eq("+x+")"),x,b)))}H=!1;q.infiniteSlider?k!=ba[F]&&(H=!0):b!=L[F]&&(H=!0);H&&""!=q.onSlideComplete&&(e[e.length]=m.onSlideCompleteTimer(10*(h+1),q,c,a(c).children(":eq("+k+")"),k,F));Y[F]=e;m.hideScrollbar(q,e,h,A,f,g,l,u,v,F);m.autoSlide(c,d,e,f,g,l,n,u,v,w,p,D,F,y,t,G,q)},autoSlide:function(a,b,c,d,e,f,g,l,n,u,p,v,w,D,y,t,G){if(!U[w].autoSlide)return!1;m.autoSlidePause(w);W[w]=setTimeout(function(){!G.infiniteSlider&&
L[w]>p.length-1&&(L[w]-=y);m.changeSlide((L[w]+M[w]+p.length+1)%p.length,a,b,c,d,e,f,g,l,n,u,p,v,w,D,y,t,G);m.autoSlide(a,b,c,d,e,f,g,l,n,u,p,v,w,D,y,t,G)},G.autoSlideTimer+G.autoSlideTransTimer)},autoSlidePause:function(a){clearTimeout(W[a])},isUnselectable:function(b,c){return""!=c.unselectableSelector&&1==a(b).closest(c.unselectableSelector).length?!0:!1},slowScrollHorizontalIntervalTimer:function(a,b,c,d,e,f,g,l,n,u,p,w,v,G,D,t,z,q,B,C){return setTimeout(function(){m.slowScrollHorizontalInterval(b,
c,d,e,f,g,l,n,u,p,w,v,G,D,t,z,q,B,C)},a)},onSlideCompleteTimer:function(a,b,c,d,e,f){return setTimeout(function(){m.onSlideComplete(b,c,d,e,f)},a)},hideScrollbarIntervalTimer:function(a,b,c,d,e,f,g,l,n,u){return setTimeout(function(){m.hideScrollbarInterval(b,c,d,e,f,g,l,n,u)},a)},args:function(b,c,d,e,f,g){this.prevSlideNumber=void 0==a(d).parent().data("args")?void 0:a(d).parent().data("args").prevSlideNumber;this.prevSlideObject=void 0==a(d).parent().data("args")?void 0:a(d).parent().data("args").prevSlideObject;
this.targetSlideNumber=g+1;this.targetSlideObject=a(d).children(":eq("+g+")");this.slideChanged=!1;"load"==b?this.targetSlideObject=this.targetSlideNumber=void 0:"start"==b?this.targetSlideObject=this.targetSlideNumber=void 0:"change"==b?(this.slideChanged=!0,this.prevSlideNumber=void 0==a(d).parent().data("args")?c.startAtSlide:a(d).parent().data("args").currentSlideNumber,this.prevSlideObject=a(d).children(":eq("+this.prevSlideNumber+")")):"complete"==b&&(this.slideChanged=a(d).parent().data("args").slideChanged);
...
(z[k]+C)/3);""!=h.navSlideSelector&&a(h.navSlideSelector).each(function(b){a(this).css({cursor:"pointer"});a(this).unbind(da).bind(da,function(c){"touchstart"==c.type?a(this).unbind("click.iosSliderEvent"):a(this).unbind("touchstart.iosSliderEvent");da=c.type+".iosSliderEvent";m.changeSlide(b,I,J,x,E,y,C,F,T,V,X,r,R,k,aa,N,q,h)})});""!=h.navPrevSelector&&(a(h.navPrevSelector).css({cursor:"pointer"}),a(h.navPrevSelector).unbind(da).bind(da,function(b){"touchstart"==b.type?a(this).unbind("click.iosSliderEvent"):
a(this).unbind("touchstart.iosSliderEvent");da=b.type+".iosSliderEvent";b=(L[k]+M[k]+N)%N;(0<b||h.infiniteSlider)&&m.changeSlide(b-1,I,J,x,E,y,C,F,T,V,X,r,R,k,aa,N,q,h)}));""!=h.navNextSelector&&(a(h.navNextSelector).css({cursor:"pointer"}),a(h.navNextSelector).unbind(da).bind(da,function(b){"touchstart"==b.type?a(this).unbind("click.iosSliderEvent"):a(this).unbind("touchstart.iosSliderEvent");da=b.type+".iosSliderEvent";b=(L[k]+M[k]+N)%N;(b<r.length-1||h.infiniteSlider)&&m.changeSlide(b+1,I,J,x,
E,y,C,F,T,V,X,r,R,k,aa,N,q,h)}));h.autoSlide&&!fa&&""!=h.autoSlideToggleSelector&&(a(h.autoSlideToggleSelector).css({cursor:"pointer"}),a(h.autoSlideToggleSelector).unbind(da).bind(da,function(b){"touchstart"==b.type?a(this).unbind("click.iosSliderEvent"):a(this).unbind("touchstart.iosSliderEvent");da=b.type+".iosSliderEvent";na?(m.autoSlide(I,J,x,E,y,C,F,T,V,X,r,R,k,aa,N,q,h),na=!1,a(h.autoSlideToggleSelector).removeClass("on")):(m.autoSlidePause(k),na=!0,a(h.autoSlideToggleSelector).addClass("on"))}));
m.autoSlide(I,J,x,E,y,C,F,T,V,X,r,R,k,aa,N,q,h);a(B).bind("mouseleave.iosSliderEvent",function(){if(na)return!0;m.autoSlide(I,J,x,E,y,C,F,T,V,X,r,R,k,aa,N,q,h)});a(B).bind("touchend.iosSliderEvent",function(){if(na)return!0;m.autoSlide(I,J,x,E,y,C,F,T,V,X,r,R,k,aa,N,q,h)});h.autoSlideHoverPause&&a(B).bind("mouseenter.iosSliderEvent",function(){m.autoSlidePause(k)});a(B).data("iosslider",{obj:Ea,settings:h,scrollerNode:I,slideNodes:J,numberOfSlides:N,centeredSlideOffset:q,sliderNumber:k,originalOffsets:X,
childrenOffsets:r,sliderMax:z[k],scrollbarClass:E,scrollbarWidth:y,scrollbarStageWidth:F,stageWidth:C,scrollMargin:T,scrollBorder:V,infiniteSliderOffset:M[k],infiniteSliderWidth:aa,slideNodeOuterWidths:R,shortContent:fa});va=!1;return!0}b++;var k=b,x=[];U[k]=a.extend({},h);p[k]=0;z[k]=0;var v=[0,0],S=[0,0],Q="scrollbarBlock"+b,E="scrollbar"+b,O,W,F,y,t,Z,q=0,B=a(this),C,P,T,V,Ba,va=!0;g=-1;var r,X=[],wa=0,ia=0,Fa=0,I=a(this).children(":first-child"),J,ka,R,N=a(I).children().not("script").length,ga=
!1,Da=0,ya=!1,sa=void 0,aa;M[k]=0;var fa=!1,na=!1;ma[k]=!1;var ja,ta=!1,oa=!1,da="touchstart.iosSliderEvent click.iosSliderEvent",ea,xa,Ca,ra;ha[k]=!1;Y[k]=[];h.scrollbarDrag&&(h.scrollbar=!0,h.scrollbarHide=!1);var Ea=a(this);if(void 0!=Ea.data("iosslider"))return!0;var pa=[],qa=Math.floor(12317*Math.random());a(I).parent().append("<i class = 'i"+qa+"'></i>").append("<i class = 'i"+qa+"'></i>");a(".i"+qa).css({position:"absolute",right:"10px",bottom:"10px",zIndex:1E3,fontStyle:"normal",background:"#fff",
opacity:.2}).eq(1).css({bottom:"auto",right:"auto",top:"10px",left:"10px"});for(g=0;g<pa.length;g++)a(".i"+qa).html(a(".i"+qa).html()+pa[g]);14.2<=parseInt(a().jquery.split(".").join(""),10)?a(this).delegate("img","dragstart.iosSliderEvent",function(a){a.preventDefault()}):a(this).find("img").bind("dragstart.iosSliderEvent",function(a){a.preventDefault()});h.infiniteSlider&&(h.scrollbar=!1);h.infiniteSlider&&1==N&&(h.infiniteSlider=!1);h.scrollbar&&(""!=h.scrollbarContainer?a(h.scrollbarContainer).append("<div class = '"+
Q+"'><div class = '"+E+"'></div></div>"):a(I).parent().append("<div class = '"+Q+"'><div class = '"+E+"'></div></div>"));if(!H())return!0;a(this).find("a").bind("mousedown",m.preventDrag);a(this).find("[onclick]").bind("click",m.preventDrag).each(function(){a(this).data("onclick",this.onclick)});g=m.calcActiveOffset(h,m.getSliderOffset(a(I),"x"),r,C,M[k],N,void 0,k);g=(g+M[k]+N)%N;g=new m.args("load",h,I,a(I).children(":eq("+g+")"),g,g);a(B).data("args",g);if(""!=h.onSliderLoaded)h.onSliderLoaded(g);
if(U[k].responsiveSlides||U[k].responsiveSlideContainer)g=l?"orientationchange":"resize",a(window).bind(g+".iosSliderEvent-"+k,function(){if(!H())return!0;var b=a(B).data("args");if(""!=h.onSliderResize)h.onSliderResize(b)});!h.keyboardControls&&!h.tabToAdvance||fa||a(document).bind("keydown.iosSliderEvent",function(a){n||u||(a=a.originalEvent);if(ha[k])return!0;if(37==a.keyCode&&h.keyboardControls)a.preventDefault(),a=(L[k]+M[k]+N)%N,(0<a||h.infiniteSlider)&&m.changeSlide(a-1,I,J,x,E,y,C,F,T,V,X,
r,R,k,aa,N,q,h);else if(39==a.keyCode&&h.keyboardControls||9==a.keyCode&&h.tabToAdvance)a.preventDefault(),a=(L[k]+M[k]+N)%N,(a<r.length-1||h.infiniteSlider)&&m.changeSlide(a+1,I,J,x,E,y,C,F,T,V,X,r,R,k,aa,N,q,h)});if(f||h.desktopClickDrag){var la=!1,za=!1;g=a(I);var ua=a(I),Aa=!1;h.scrollbarDrag&&(g=g.add(O),ua=ua.add(W));a(g).bind("mousedown.iosSliderEvent touchstart.iosSliderEvent",function(b){if(la)return!0;la=!0;za=!1;"touchstart"==b.type?a(ua).unbind("mousedown.iosSliderEvent"):a(ua).unbind("touchstart.iosSliderEvent");
if(ha[k]||fa||(Aa=m.isUnselectable(b.target,h)))return ga=la=!1,!0;ja=a(this)[0]===a(O)[0]?O:I;n||u||(b=b.originalEvent);m.autoSlidePause(k);ra.unbind(".disableClick");if("touchstart"==b.type)eventX=b.touches[0].pageX,eventY=b.touches[0].pageY;else{if(window.getSelection)window.getSelection().empty?window.getSelection().empty():window.getSelection().removeAllRanges&&window.getSelection().removeAllRanges();else if(document.selection)if(u)try{document.selection.empty()}catch(Ga){}else document.selection.empty();
eventX=b.pageX;eventY=b.pageY;ya=!0;sa=I;a(this).css({cursor:D})}v=[0,0];S=[0,0];c=0;ga=!1;for(b=0;b<x.length;b++)clearTimeout(x[b]);b=m.getSliderOffset(I,"x");b>-1*p[k]+q+ea?(b=-1*p[k]+q+ea,m.setSliderOffset(a("."+E),b),a("."+E).css({width:y-V+"px"})):b<-1*z[k]&&(m.setSliderOffset(a("."+E),F-T-y),a("."+E).css({width:y-V+"px"}));b=a(this)[0]===a(O)[0]?p[k]:0;ia=-1*(m.getSliderOffset(this,"x")-eventX-b);m.getSliderOffset(this,"y");v[1]=eventX;S[1]=eventY;oa=!1});a(document).bind("touchmove.iosSliderEvent mousemove.iosSliderEvent",
...
a(this).data("events");if(void 0!=b&&void 0!=b.click&&"iosSliderEvent"!=b.click[0].namespace){if(!ga)return!1;a(this).one("click.disableClick",m.preventClick);b=a(this).data("events").click;var c=b.pop();b.splice(0,0,c)}});if(!ma[k]){if(fa)return!0;h.desktopClickDrag&&a(I).css({cursor:w});h.scrollbarDrag&&a(O).css({cursor:w});ya=!1;if(void 0==sa)return!0;m.slowScrollHorizontal(sa,J,x,E,c,d,y,C,F,T,V,X,r,R,k,aa,N,ja,oa,q,h);sa=void 0}la=ta=!1})}})},destroy:function(b,c){void 0==c&&(c=this);return a(c).each(function(){var c=
a(this),d=c.data("iosslider");if(void 0==d)return!1;void 0==b&&(b=!0);m.autoSlidePause(d.sliderNumber);ma[d.sliderNumber]=!0;a(window).unbind(".iosSliderEvent-"+d.sliderNumber);a(document).unbind(".iosSliderEvent-"+d.sliderNumber);a(document).unbind("keydown.iosSliderEvent");a(this).unbind(".iosSliderEvent");a(this).children(":first-child").unbind(".iosSliderEvent");a(this).children(":first-child").children().unbind(".iosSliderEvent");b&&(a(this).attr("style",""),a(this).children(":first-child").attr("style",
...
1);a(c.stageNode).data("args",b);if(""!=c.settings.onSliderUpdate)c.settings.onSliderUpdate(b)})},addSlide:function(b,c){return this.each(function(){var d=a(this),e=d.data("iosslider");if(void 0==e)return!1;0==a(e.scrollerNode).children().length?(a(e.scrollerNode).append(b),d.data("args").currentSlideNumber=1):e.settings.infiniteSlider?(1==c?a(e.scrollerNode).children(":eq(0)").before(b):a(e.scrollerNode).children(":eq("+(c-2)+")").after(b),-1>M[e.sliderNumber]&&L[e.sliderNumber]--,d.data("args").currentSlideNumber>=
c&&L[e.sliderNumber]++):(c<=e.numberOfSlides?a(e.scrollerNode).children(":eq("+(c-1)+")").before(b):a(e.scrollerNode).children(":eq("+(c-2)+")").after(b),d.data("args").currentSlideNumber>=c&&d.data("args").currentSlideNumber++);d.data("iosslider").numberOfSlides++;Z.update(this)})},removeSlide:function(b){return this.each(function(){var c=a(this),d=c.data("iosslider");if(void 0==d)return!1;a(d.scrollerNode).children(":eq("+(b-1)+")").remove();L[d.sliderNumber]>b-1&&L[d.sliderNumber]--;c.data("iosslider").numberOfSlides--;
...
function(){b.updateSize()});b.st.closeOnContentClick||(l+=" mfp-auto-cursor");l&&b.wrap.addClass(l);h=b.wH=G.height();f={};b.fixedContentPos&&b._hasScrollBar(h)&&(g=b._getScrollbarSize())&&(f.marginRight=g);b.fixedContentPos&&(b.isIE7?a("body, html").css("overflow","hidden"):f.overflow="hidden");g=b.st.mainClass;return b.isIE7&&(g+=" mfp-ie7"),g&&b._addClassToMFP(g),b.updateItemHTML(),D("BuildControls"),a("html").css(f),b.bgOverlay.add(b.wrap).prependTo(b.st.prependTo||d),b._lastFocusedEl=document.activeElement,
...
2;c+f.outerHeight(!0)>window.innerHeight&&(c-=c+f.outerHeight(!0)-window.innerHeight);n=n.length?n.outerHeight(!0):0;n>c&&(c=n);n={top:c,right:l,width:""};c=f.data("width-preview");0<g&&(n.width=c+g);f.css(n);f.data("right-value",l+g);f.css("visibility","visible")},function(c){a(".td-screen-demo-extend:first").hide();var d=a(".td-screen-demo:first");c=d.css("right");var e=d.css("padding-right"),f=d.css("width"),l=parseInt(c.replace("px","")),g=parseInt(e.replace("px","")),n=parseInt(f.replace("px",
""));c=a(this);tdDemoMenu._currentElement=c;var u=parseInt(a("#td-theme-settings").css("width").replace("px",""));0<g?(b!==tdDemoMenu.startTimeout&&(window.clearTimeout(tdDemoMenu.startTimeout),tdDemoMenu.startTimeout=b),b!==tdDemoMenu.startInterval&&(window.clearInterval(tdDemoMenu.startInterval),tdDemoMenu.startInterval=b),tdDemoMenu.startTimeout=setTimeout(function(){tdDemoMenu._extendedDemo=!0;tdDemoMenu.startInterval=setInterval(function(){var c=d.data("width-preview");l+=10;g-=10;n-=10;var e=
...
a)?g.sidebar_state="case_4_fixed_up":"up"===d&&!0===tdSmartSidebar._is_smaller_or_equal(f,g.sidebar_top)&&(g.sidebar_state="case_2_top_of_content"),"case_1_fixed_down"===g.sidebar_state&&"up"===d||"case_4_fixed_up"===g.sidebar_state&&"down"===d)g.sidebar_state="case_5_absolute";var n=0,u=tdViewport.getCurrentIntervalItem();null!==u&&(n=u.sidebarWidth);switch(g.sidebar_state){case "case_1_fixed_down":if(!0===g.case_1_run_once)break;tdSmartSidebar.log("sidebar_id: "+l+" "+g.sidebar_state);g.case_1_run_once=
...
"enabled"==tdUtil.getBackendVar("tds_smart_sidebar")&&!1===tdDetect.isIos&&jQuery(window).load(function(){jQuery(".td-ss-row").each(function(){var a=new tdSmartSidebar.item;a.sidebar_jquery_obj=jQuery(this).children(".td-pb-span3").find(".wpb_wrapper:first");a.content_jquery_obj=jQuery(this).children(".td-pb-span9").find(".wpb_wrapper:first");tdSmartSidebar.add_item(a)});if(0<jQuery(".td-ss-main-content").length&&0<jQuery(".td-ss-main-sidebar").length){var a=new tdSmartSidebar.item;a.sidebar_jquery_obj=
