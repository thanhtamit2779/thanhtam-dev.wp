...
if (tdUtil.getBackendVar('tds_smart_sidebar') == 'enabled' && tdDetect.isIos === false) {
    jQuery(window).load(function() {
        ...
        jQuery('.td-ss-row').each(function () {
            ...
            td_smart_sidebar_item.sidebar_jquery_obj = jQuery(this).children('.td-pb-span3').find('.wpb_wrapper:first');
            td_smart_sidebar_item.content_jquery_obj = jQuery(this).children('.td-pb-span9').find('.wpb_wrapper:first');
