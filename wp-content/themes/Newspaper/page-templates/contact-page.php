...
?>
	<script type="text/javascript">
		jQuery(document).ready(function(){
			jQuery('#map').gMap({
				scrollwheel: false,
				zoom: <?php echo esc_js($hugeshop_opt['map_zoom']);?>,
				<?php if($hugeshop_opt['address_by']=='address') : ?>
				address: "<?php echo  esc_js($hugeshop_opt['map_address']);?>",
				<?php endif; ?>
				markers:[
					<?php if($hugeshop_opt['address_by']=='coordinate') : ?>
					{
						latitude: <?php echo  esc_js($hugeshop_opt['map_lat']);?>,
						longitude: <?php echo  esc_js($hugeshop_opt['map_long']);?>,
						...
						icon: {
							<?php if( isset($hugeshop_opt['map_marker']['url']) && $hugeshop_opt['map_marker']['url']!='') : ?>
							image: "<?php echo  esc_js($hugeshop_opt['map_marker']['url']); ?>",
							<?php else : ?>
